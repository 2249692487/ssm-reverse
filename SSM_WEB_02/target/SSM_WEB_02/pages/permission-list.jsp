                            ...
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="新建"
                                            onclick='location.href="${pageContext.request.contextPath}/sysPermission/toAddPermissionPage"'>
                            ...
                            <c:forEach items="${sysPermissionList}" var="permission">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="${pageContext.request.contextPath}/sysPermission/findAllPermissionList"
