				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<script type="text/javascript">
                            // 页面加载完成后执行
                            $(function(){
                                // 选中保存状态的下拉框 再选中对应option, 指定属性selected为true
                                $("select[name='productStatus'] option[value='${product.productStatus}']").prop("selected", true);
                                // select[name='productStatus']  选中保存状态的下拉框
                                //  option[value='${product.productStatus}']  <option value="0">下架</option> <option value="1">上架</option> 再选中对应option,
                                //  prop("selected", true); <option value="0" seleted="true">下架</option> 指定属性selected为true
                            });
						</script>
