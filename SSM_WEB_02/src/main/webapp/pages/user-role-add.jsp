...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <form action="${pageContext.request.contextPath}/sysUser/updateUserRole" method="post">
            <!-- 正文区域 -->
            <section class="content"><input type="hidden" name="id" value="${id}">
                <table id="dataList"
                    ...
                    <c:forEach items="${sysRoleList}" var="role">
                        <tr>
                            <td><input name="ids" type="checkbox" ${fn:contains(roleIdList,role.id) ? "checked" : ""} value="${role.id}"></td>
                            <td>${role.id}</td>
                            <td>${role.roleName }</td>
                            <td>${role.roleDesc}</td>
